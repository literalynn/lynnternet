...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ------------------------------
    const SERVERS = [
      { id: 'ltn1', name: 'ltn1', api: 'https://api.lynnternet.cloud/api/stats', description: 'Plex media server', services: '' },
      { id: 'ltn2', name: 'ltn2', api: '', description: 'Game servers', services: '' },
      { id: 'ltn0', name: 'ltn0', api: '', description: 'Proxy', services: '' }
    ];
    ...
    // ------------------------------
    // 3) Génération DOM conditionnelle
    // ------------------------------
    ...
    function initCharts(s) {
      ...
      // Pré-remplir avec l'historique éventuel
    ...
    async function updateStats(s) {
      ...
      try {
        ...
        if (storageList) {
          // (re)build list si taille change
    ...
    // ------------------------------
    // 5) Effet "spotlight 3D"
    // (fix opérateur de priorité: angle correctement modulo 360)
    // ------------------------------
    setupSpotlightCards();
